...
class UserModel: NSObject {
    ...
    var passwordMD5:String {
        get{
            if self._passwordMD5 == nil {
                if UserDefaults.standard.object(forKey: "PASSWORDMD5") != nil {
                    self._passwordMD5 = UserDefaults.standard.object(forKey: "PASSWORDMD5") as? String
                    return self._passwordMD5!
                }
                return ""
            }else{
                return self._passwordMD5!
        ...
        get{
            if self._nickName == nil {
                if UserDefaults.standard.object(forKey: "NICKNAME") != nil {
                    self._nickName = UserDefaults.standard.object(forKey: "NICKNAME") as? String
